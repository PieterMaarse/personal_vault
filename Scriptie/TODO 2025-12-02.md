...
- [ ] Toevoegen
	...
	- [ ] Performance metric kiezen
		- [ ] F1 score?
			- [ ] Voorspelt bijna alleen maar non-supervisory
		- [ ] Balanced precision & recall?
			- [ ] Voor gegeven model, kies threshold waarvoor precision en recall het dichtst bij elkaar liggen
			- [ ] gemiddeld van de twee is dan performance
			- [ ] ==HIER GEBLEVEN==
	- [ ] CV
